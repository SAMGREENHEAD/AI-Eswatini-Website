      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {members.map((m) => (
            <div
              key={m.name}
              className="flex flex-col items-center text-center bg-gray-800 dark:bg-gray-800 shadow-lg rounded-2xl p-6 transition-transform duration-200 hover:scale-[1.02] hover:shadow-xl"
            >
              <img
                src={m.img}
                alt={m.name}
